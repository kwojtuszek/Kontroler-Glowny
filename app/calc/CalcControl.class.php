...
require_once $conf->root_path.'/app/calc/CalcVariables.class.php';
...
class CalcControl {
    ...
    public function generateView() {
        ...
        $smarty -> assign('page_title', 'Kalkulator Kredytowy: Kontroler Główny');
        ...
        $smarty -> display($conf->root_path.'/app/calc/credit_view.tpl');
    }
}